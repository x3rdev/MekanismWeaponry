...
public class PlasmaRifleRenderer extends GunRenderer<PlasmaRifleItem> {
    ...
    public PlasmaRifleRenderer() {
        super(new DefaultedItemGeoModel<>(new ResourceLocation(MekanismWeaponry.MOD_ID, "plasma_rifle")));
    }

    @Override
    public ResourceLocation getTextureLocation(PlasmaRifleItem animatable) {
        return new ResourceLocation(MekanismWeaponry.MOD_ID, String.format("textures/item/plasma_rifle/plasma_rifle_%d.png", getTextureIndex()));
    }
}
