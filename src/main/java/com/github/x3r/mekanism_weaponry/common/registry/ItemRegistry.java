...
public class ItemRegistry {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MekanismWeaponry.MOD_ID);

    public static final RegistryObject<GauntletItem> GAUNTLET = ITEMS.register("gauntlet",
            () -> new GauntletItem(new Item.Properties()));

    public static final RegistryObject<PlasmaRifleItem> PLASMA_RIFLE = ITEMS.register("plasma_rifle",
    ...
    public static final RegistryObject<TeslaMinigunItem> TESLA_MINIGUN = ITEMS.register("tesla_minigun",
            () -> new TeslaMinigunItem(new Item.Properties()));

    public static final RegistryObject<BlockItem> WEAPON_WORKBENCH = ITEMS.register("weapon_workbench",
    ...
    public static final RegistryObject<Item> PLASMA_CIRCUIT = ITEMS.register("plasma_circuit",
            () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> MAGNETIC_CIRCUIT = ITEMS.register("magnetic_circuit",
            () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> FIRE_RATE_CHIP_1 = ITEMS.register("fire_rate_chip_1",
            () -> new FireRateChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 1.0F));
    public static final RegistryObject<Item> FIRE_RATE_CHIP_2 = ITEMS.register("fire_rate_chip_2",
            () -> new FireRateChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 2.0F));
    public static final RegistryObject<Item> FIRE_RATE_CHIP_3 = ITEMS.register("fire_rate_chip_3",
            () -> new FireRateChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 3.0F));
    public static final RegistryObject<Item> FIRE_RATE_CHIP_4 = ITEMS.register("fire_rate_chip_4",
            () -> new FireRateChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 4.0F));

    public static final RegistryObject<Item> ENERGY_USAGE_CHIP_1 = ITEMS.register("energy_usage_chip_1",
            () -> new EnergyUsageChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 1.0F));
    public static final RegistryObject<Item> ENERGY_USAGE_CHIP_2 = ITEMS.register("energy_usage_chip_2",
            () -> new EnergyUsageChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 2.0F));
    public static final RegistryObject<Item> ENERGY_USAGE_CHIP_3 = ITEMS.register("energy_usage_chip_3",
            () -> new EnergyUsageChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 3.0F));
    public static final RegistryObject<Item> ENERGY_USAGE_CHIP_4 = ITEMS.register("energy_usage_chip_4",
            () -> new EnergyUsageChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 4.0F));

    public static final RegistryObject<Item> HEAT_PER_SHOT_CHIP_1 = ITEMS.register("heat_per_shot_chip_1",
            () -> new HeatPerShotChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 1.0F));
    public static final RegistryObject<Item> HEAT_PER_SHOT_CHIP_2 = ITEMS.register("heat_per_shot_chip_2",
            () -> new HeatPerShotChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 2.0F));
    public static final RegistryObject<Item> HEAT_PER_SHOT_CHIP_3 = ITEMS.register("heat_per_shot_chip_3",
            () -> new HeatPerShotChipItem(new Item.Properties(), GunAddonItem.AddonType.CHIP, 3.0F));
    public static final RegistryObject<Item> HEAT_PER_SHOT_CHIP_4 = ITEMS.register("heat_per_shot_chip_4",
...
//            () -> new PaintBucketItem(new Item.Properties(), "nimbus", 0xFF2b9fe8, 0xFF817a99, 0));
    public static final RegistryObject<PaintBucketItem> ALIEN_PAINT_BUCKET = ITEMS.register("alien_paint_bucket",
            () -> new PaintBucketItem(new Item.Properties(), "alien", 0xFFbe54e0, 0xFF00f23f, 1));
    public static final RegistryObject<PaintBucketItem> COTTON_CANDY_PAINT_BUCKET = ITEMS.register("cotton_candy_paint_bucket",
            () -> new PaintBucketItem(new Item.Properties(), "cotton_candy", 0xFF0088c1, 0xFFb139b6, 2));
    public static final RegistryObject<PaintBucketItem> EVA_PAINT_BUCKET = ITEMS.register("eva_paint_bucket",
            () -> new PaintBucketItem(new Item.Properties(), "eva", 0xFF00f23f, 0xFFbe54e0, 3));
    public static final RegistryObject<PaintBucketItem> BUMBLEBEE_PAINT_BUCKET = ITEMS.register("bumblebee_paint_bucket",
            () -> new PaintBucketItem(new Item.Properties(), "bumblebee", 0xFFfa7900, 0xFFffd833, 4));
    public static final RegistryObject<PaintBucketItem> CRIMSON_PAINT_BUCKET = ITEMS.register("crimson_paint_bucket",
    ...
    public static class ModItemTab {
        ...
        public static final RegistryObject<CreativeModeTab> MEKW_ITEM_TAB = CREATIVE_MODE_TABS.register("main", () -> CreativeModeTab.builder()
                .icon(() -> PLASMA_RIFLE.get().getDefaultInstance())
